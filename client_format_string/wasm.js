...
var ASM_CONSTS = {
  1736: function($0) {document.getElementById('result').innerHTML = "Correct Password!"; document.getElementById('password').innerHTML = "The password is: " + UTF8ToString($0);},  
 1895: function() {document.getElementById('result').innerHTML = "Wrong Password"; document.getElementById('password').innerHTML = "";}
};
